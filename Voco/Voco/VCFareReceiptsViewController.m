//
//  VCFareReceiptsViewController.m
//  Voco
//
...
@implementation VCFareReceiptsViewController
...
- (void)tableView:(UITableView *)tableView collapseCell:(UITableViewCell *)cell withIndexPath:(NSIndexPath *)indexPath {
    ...
    VCFareReceiptExpandedTableViewCell * receiptCell = (VCFareReceiptExpandedTableViewCell * ) cell;
...
/*
 ...
 cell.detailTextLabel.text = [NSString stringWithFormat:@"%@ / %@", earning.stripeChargeStatus, earning.motive];
 }
 */
